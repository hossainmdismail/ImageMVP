    ...
    return (
      <button
        ...
        className={cn(
          ...
          "px-3 pb-4 pt-5 sm:px-6 sm:pb-7",
          active
      ...
      >
        ...
        <div className="relative mx-auto h-[90px] w-full max-w-[260px] sm:h-[110px]">
          <Image
            src={image}
            alt={title}
            fill
        ...
        <div className="mt-5">
          <div className="text-md font-black leading-tight text-white">{title}</div>
          <p className="mt-2 text-xs font-extralight tracking-normal sm:text-sm text-white/30">{description}</p>
        </div>
      </button>
    );
  }
